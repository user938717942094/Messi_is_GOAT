...
#     ccw_timer=threading.Timer(5, agv.counterclockwise_rotation, (10))
#     cw_timer=threading.Timer(5, agv.clockwise_rotation, (10))
#     ccw_timer.start()
#     cw_timer.start()
...
def process_frame(frame):
    ...
    lower_purple = np.array([74,0,53], dtype=np.uint8)
    upper_purple = np.array([180,100,230], dtype=np.uint8)
...
def perform_route_action():
    threading.Timer(10, agv.pan_left, (10)).start()
