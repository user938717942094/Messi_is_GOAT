...
# YOLO 모델 설정
net = cv2.dnn.readNet("./1_Common/Camera/2_YOLO/Src/yolov3.weights", "./1_Common/Camera/2_YOLO/Src/yolov3.cfg")
classes = []
with open("./1_Common/Camera/2_YOLO/Src/coco.names", "r") as f:
